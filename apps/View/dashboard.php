  ...
  <div id="wrapper">
    ...
    <div class="container-fluid">
      <div class="d-sm-flex justify-content-between align-items-center mb-4">
        <h3 class="text-dark mb-0">Welcome!</h3><a class="btn btn-danger btn-sm d-none d-sm-inline-block" role="button" href="https://github.com/K-Kraken/REMS-For-Organisations/issues" style="background-color: #ce1126;border-color: #e5053a;"><i class="fas fa-bug fa-sm text-white-50"></i>&nbsp;Raise a Issue</a>
      </div>
      <div class="row">
              ...
              <div class="row align-items-center no-gutters">
                <div class="col mr-2">
                  <div class="text-uppercase text-primary font-weight-bold text-xs mb-1">
                    <span>Registrations for <?= ucwords(str_replace("event ", "", (str_replace("_", " ", $eventTable)))); ?> (Latest)</span>
                  </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="db-ops/pushAlert.php">
                    <?php if (retIsAdmin($_SESSION['uname']) == 1) {
