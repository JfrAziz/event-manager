...
<head>
    ...
    <title>Login:<?php echo " ".$OrgName; ?></title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="validate.php" method="POST">
                                        <div class="form-group">
                                            <input type="hidden" value="unknown" name="ipadd" id="ipadd" />
                                            <input class="form-control form-control-user" type="text" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Username..." name="uname" required>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control form-control-user" type="password" id="exampleInputPassword" placeholder="Password (Shhh....)" name="password" required>
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <div class="form-check">
                                                    <input class="form-check-input custom-control-input" name="remember" value="1" type="checkbox" id="formCheck-1">
